 ...
 *
 */
package com.mind_era.knime.vega.batch.internal;
 ...
 */
public class BatchVegaViewerNodePlugin extends AbstractUIPlugin {
	// The shared instance.
	private static BatchVegaViewerNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public BatchVegaViewerNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static BatchVegaViewerNodePlugin getDefault() {
		return plugin;
	}
