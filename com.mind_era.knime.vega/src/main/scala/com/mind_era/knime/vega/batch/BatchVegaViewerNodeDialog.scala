...
class BatchVegaViewerNodeDialog protected[batch] () extends DefaultNodeSettingsPane {
  ...
  addDialogComponent(new DialogComponentMultiLineString(
    new SettingsModelString(CFGKEY_VEGA_SPEC, DEFAULT_VEGA_SPEC), "Vega specification"))
  addDialogComponent(new DialogComponentMultiLineString(new SettingsModelString(CFGKEY_MAPPING, DEFAULT_MAPPING), "Mapping"))
  addDialogComponent(new DialogComponentStringSelection(new SettingsModelString(CFGKEY_FORMAT, DEFAULT_FORMAT), "Image format", POSSIBLE_FORMATS: _*))
